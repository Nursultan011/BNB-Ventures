    ...
    <div class="container">
      <div class="requirement__inner">
        <div class="left">
          ...
          <p v-if="currentTab.title">{{ currentTab.title }}</p>
        </div>
        <div class="right">
    ...
    const tabs = ref([
      {
        name: "Стартап",
        path: "startup",
        title: "Какие требования для cтартапа?",
        info: [
          {
      ...
      },
      {
        name: "Инвесторы",
        path: "investor",
        title: "Какие требования для инвестора?",
        info: [
          {
            title: "Технологический уклон в инновации",
            description: "Обязательно наличие инновационной технологии",
      ...
      },
      {
        name: "Специалисты",
        path: "specialist",
        title: "Какие требования для специалиста?",
        info: [
          {
            title: "Технологический уклон в инновации",
            description: "Обязательно наличие инновационной технологии",
